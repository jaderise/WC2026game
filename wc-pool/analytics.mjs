    ...
    newEdition = {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            "**Brent** ran a superb tournament. He led the pool almost wire-to-wire, read the group stage better than anyone — the best record in the field, 47 of 72 results correct — and called all four semifinalists spot on. He had France for the crown, and it took the very last kick of the tournament to separate the top two: when the final went Spain's way, the title changed hands by just six points. A brilliant month that came down to the finest of margins.",
            "**Jason** stayed in touch all the way and needed the final to fall right. He had Spain, and their win delivered the 21 champion points that nudged him to **211**, a whisker clear of Brent's 205. After a month of football, the pool came down to a single line on the ballot: who had the champion.",
            "Only three of the fourteen backed Spain, and all three were the **DeRise brothers** — Jason (1st), Eric (3rd) and Greg (5th) — who had put their Spanish heritage on the line back in June. The seven who crowned France were far from wrong about them: France's attack was one of the tournament's most thrilling and carried them all the way to the last four. They simply met the eventual champions at the worst moment — a Spanish defense that refused to be broken shut the door in the semifinal.",
            "**Eric** saved his best for the business end. Nobody read the knockouts better — both finalists and the champion, all correct — and he came storming up the table through the later rounds to finish third, one of the sharpest closing runs in the pool.",
            "And spare a thought for the **England** backers — Andrew, Rebecca and Gary — who rode a genuine contender almost the whole way. England were within touching distance of the final before Argentina edged them 2–1 in the semifinal: so close to the biggest points on the board, and agonizingly short right at the end. There is real comfort in it, though — third place is England's best World Cup finish since they lifted the trophy in 1966.",
          ],
        },
        {
